...
import { Client } from '../interfaces/_Models';
  ...
  private setHeaders() {
    ...
    */
    ...
    public clients = () : Observable<Client[]> => {
        return this._http.request(this.actionUrl + `api/clients/clients`, new RequestOptions({
            headers: this.headers,
            method: "get",
            body: ArrayUtilities.serializeCircularToJson(null)
        })).pipe(map(res => (ArrayUtilities.rebuildJsonDotNetObj(<Client[]>res.json()))))
