...
export class ScraperService {
  ...
  private setHeaders() {
    ...
    */
    ...
    public getDataFromRomList = (romListId: number) : Observable<string> => {
        return this._http.request(this.actionUrl + `api/scraper/getdatafromromlist?romListId=${romListId}`, new RequestOptions({
