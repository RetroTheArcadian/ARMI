...
import { Emulator } from '../interfaces/_Models';
...
export class EmulatorService {
  ...
  private setHeaders() {
    ...
    */
    ...
    public emulators = () : Observable<Emulator[]> => {
        return this._http.request(this.actionUrl + `api/emulators/emulators`, new RequestOptions({
            headers: this.headers,
            method: "get",
            body: ArrayUtilities.serializeCircularToJson(null)
        })).pipe(map(res => (ArrayUtilities.rebuildJsonDotNetObj(<Emulator[]>res.json()))))
